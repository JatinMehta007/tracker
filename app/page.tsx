  ...
  return (
    <div className="min-h-screen text-gray-800 overflow-hidden relative">
      <WobbleCard>
        ...
        <main className="px-6 py-8 mt-36 relative z-10">
          <div className="block md:flex justify-center items-center">
            <p className="text-5xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl text-black font-extrabold uppercase text-center">
              Welcome to
            </p>
            <div className="flex justify-center">
              <img
                src="./images/logo.png"
                alt=""
                className="h-[45px] md:h-[50px] lg:h-[70px] xl:h-[95px] mt-1 md:ml-1 sm:block"
              />
            </div>
          </div>

          <div className="md:grid md:grid-flow-col bg-gradient-to-b from-yellow-500 to-yellow-300 shadow-2xl mt-10 xl:w-[1100px] md:w-[90%] mx-auto xl:h-[500px] rounded-3xl relative z-10">
            ...
            <div className="absolute right-6 xl:h-[400px] xl:w-[500px] sm:mt-24 xl:mt-28 lg:mt-5 pointer-events-none z-0">
              <img
                src="./images/image.png"
                alt=""
                className="invisible md:visible rounded-4xl md:w-[300px] lg:w-[350px] xl:w-full"
              />
            </div>
          </div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-4 mb-6 mt-10 relative z-10">
            {dates.map((date) => (
              <button
                key={date}
          ...
          <div className="mt-10 bg-white p-6 rounded-xl shadow relative z-10">
        ...
        <footer className="text-center py-6 text-sm text-black relative z-10">
